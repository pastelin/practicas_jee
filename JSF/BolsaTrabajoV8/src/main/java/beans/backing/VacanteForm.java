...
import bean.helper.ColoniaHelpers;
...
public class VacanteForm {
    ...
    @Inject
    private ColoniaHelpers coloniaHelpers;
    ...
    public ColoniaHelpers getColoniaHelpers() {
        return coloniaHelpers;
    }

    public void setColoniaHelpers(ColoniaHelpers coloniaHelpers) {
        this.coloniaHelpers = coloniaHelpers;
    }
    ...
    public void codigoPostalListener(ValueChangeEvent valueChangeEvent) {
        ...
        int coloniaId = this.coloniaHelpers.getColoniaIdPorCP(nuevoCodigoPostal);
