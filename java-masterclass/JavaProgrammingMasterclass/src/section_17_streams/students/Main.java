...
//        Stream.generate(() -> Student.getRandomStuden(jmc, pymc))
//                .limit(10)
//                .forEach(System.out::println);


        Student[] students = new Student[1000];
        Arrays.setAll(students, (i) -> Student.getRandomStuden(jmc, pymc));

        /*
        Obtener listado del genero de los estudiantes
         */
        ...
        /*
        Obtener listado del rango de edades de los estudiantes
         */
        ...
        /*
        Obtener listado de paises de los estudiantes
         */
        ...
        /*
         * Ejemplo convirtiendo de Stream a List
         */
        ...
        /*
         * Ejemplo convirtiendo de Stream a Array
         */
        Student[] longTimeLearnersArray = Arrays.stream(students)
                .filter(s -> (s.getAge() - s.getAgeEnrolled() >= 7) &&
                        (s.getMonthsSinceActive() < 12))
                .filter(s -> !s.hasProgrammingExperience())
                .limit(5)
        ...
        /*
         * Ejemplo convirtiendo de Stream a List usando Collectors
         */
        List<Student> learners = Arrays.stream(students)
                .filter(s -> (s.getAge() - s.getAgeEnrolled() >= 7) &&
                        (s.getMonthsSinceActive() < 12))
                .filter(s -> !s.hasProgrammingExperience())
                .limit(5)
