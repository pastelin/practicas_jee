...
The method needs to find the first and the last digit of the parameter number passed to the method, using a loop and return
    ...
    public static int sumFirstAndLastDigit(int number) {
        ...
        while(number > 0) {
            if(copyNumber < 10) {
                ...
                number /= 10;
                continue;
            } else if( (number == copyNumber) || (number < 10) ) {
                sum += number % 10;
                number /= 10;
                continue;
            }
