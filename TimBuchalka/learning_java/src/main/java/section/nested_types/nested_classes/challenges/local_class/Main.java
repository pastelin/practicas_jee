package section.nested_types.nested_classes.challenges.local_class;

import section.nested_types.nested_classes.challenges.local_class.domain.Employee;
    ...
    public static void printOrderedList(List<Employee> eList, String sortField) {
        ...
        class MyEmployee {
            ...
            public MyEmployee(Employee containedEmployee) {
                ...
                fullName = String.join(" ", containedEmployee.firstName(), containedEmployee.last());
            }

            @Override
            public String toString() {
                return "%s has ben an employee for %d years".formatted(fullName, yearsWorked);
            }
        }
