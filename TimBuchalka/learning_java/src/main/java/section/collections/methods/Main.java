package section.collections.methods;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Collections.reverse(deck);
        Card.printDeck(deck, "Sorted by rank, suit in reverse", 13);
        ...
        // disjoint() method
        boolean distjoint = Collections.disjoint(deck, tens);
        System.out.println("Disjoint = " + distjoint);

        boolean distjoint2 = Collections.disjoint(tens, kings);
        System.out.println("Disjoint2 = " + distjoint2);
        ...
        if (Collections.replaceAll(deck, tenOfHearts, tenOfClubs)) {
            ...
            System.out.println("Tens of hearts not found in the list");
        }
        ...
        // min() and max() methods
        System.out.println("Best Ca     rd = " + Collections.max(deck, sortingAlgorithm));
