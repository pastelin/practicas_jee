 ...
 * 
 */
@WebServiceClient(name = "ServicioSumarImplService", targetNamespace = "http://beans/", wsdlLocation = "http://localhost:8088/ServicioSumarImplService/ServicioSumarImpl?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8088/ServicioSumarImplService/ServicioSumarImpl?wsdl");
