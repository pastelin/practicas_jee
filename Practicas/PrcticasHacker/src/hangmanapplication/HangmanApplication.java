...
public class HangmanApplication {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Welcome to hangman! I will pick a word and you will try to guess it character "
                ...
                + "Are you ready? I hope so becuase I am");
        
        System.out.println();
        
        System.out.println("I have to picked my word. Below is a picture, and below "
                + "that is your current guess, which starts off as nothing.\n Every time you "
                + "guess incorrectly, I add a body part to the picture. When thes is a full"
                + " person, you lose");
