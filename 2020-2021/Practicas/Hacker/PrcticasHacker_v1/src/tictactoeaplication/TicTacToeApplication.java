 ...
 * @version 1.0
 */
public interface TicTacToeApplication {
    ...
    public static void main(String[] args) {
        ...
        while ( doYouWantToPlay ) {
            ...
            System.out.println("Enter a single character that will reperesent you on the board");
            ...
            System.out.println("Now we can start the game. To play, enter a number and you token shall be put "
            ...
            while ( game.gameOver().equals("notOver") ) {
                ...
                if ( game.currentMarker == game.userMarker ) {
                    ...
                    System.out.println("I picket " + aiSpot + "!");
            ...
            System.out.println("Do you want to play again? Enter Y if yo do. " 
