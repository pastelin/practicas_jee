package com.example.java.managing_program_flow.overloading;
...
public class Main {
    ...
    /*
    * Sobrecarga de metodos: significa que puede crear más de una versión de un metodo
    * Se distinguen entre el numero de argumentos o los tipos de datos en argumentos
     */
